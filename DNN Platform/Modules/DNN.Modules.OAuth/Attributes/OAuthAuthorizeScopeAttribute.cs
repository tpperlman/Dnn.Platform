    ...
    class OAuthAuthorizeScopeAttribute : AuthorizeAttribute, IOverrideDefaultAuthLevel
    {
        ...
        static OAuthAuthorizeScopeAttribute()
        {
            ...
            if (portalSettings != null)
            {
                ...
                var base64EncodedKey = PortalController.GetPortalSetting("ResourceServerDecryptionKey", portalSettings.PortalId, string.Empty);
                ...
                var base64VerifierEncodedKey = PortalController.GetPortalSetting("AuthorizationServerVerificationKey", portalSettings.PortalId, string.Empty); 
